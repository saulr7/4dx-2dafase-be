...
func Routes() *mux.Router {
	...
	myRouter.HandleFunc("/GetEstiloTablero/{idColaborador}", EstiloTableroHanlder).Methods("GET")
	myRouter.HandleFunc("/UpdateEstiloTablero", UpdateEstiloTableroHanlder).Methods("POST")
